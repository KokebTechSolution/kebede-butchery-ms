...
export default function MeatDashboard() {
  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col md:flex-row relative">
      ...
      {/* Main Content */}
      <main className="flex-1 p-3 sm:p-4 md:p-6 lg:p-8 space-y-4 sm:space-y-6 overflow-y-auto pb-24 md:pb-6">
          ...
          <div className="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200 p-3 sm:p-4">
            <div className="flex items-center gap-2 sm:gap-3 mb-1 sm:mb-2">
              <div className="p-1.5 sm:p-2 bg-blue-50 rounded-lg">
                <FaClipboardList className="text-lg sm:text-xl text-blue-600" />
              </div>
