...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='product',
            name='base_unit',
            field=models.ForeignKey(help_text="The fundamental unit for this product's inventory tracking and base price (e.g., 'bottle' for Pepsi, 'liter' for Tej).", on_delete=django.db.models.deletion.PROTECT, related_name='products_as_base_unit', to='inventory.productunit'),
        ),
        migrations.AddField(
            model_name='inventorytransaction',
