    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True)),
                ('base_unit_price', models.DecimalField(decimal_places=2, help_text="Price for one unit of the 'base_unit'", max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quantity_in_base_units', models.DecimalField(decimal_places=2, default=0.0, help_text="Total quantity in the product's base unit (e.g., total bottles, total liters).", max_digits=10)),
                ('minimum_threshold_base_units', models.DecimalField(decimal_places=2, default=0.0, help_text="Minimum stock level in base units before 'running_out' is flagged.", max_digits=10)),
